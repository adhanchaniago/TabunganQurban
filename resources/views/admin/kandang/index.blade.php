        ...
        <div class="card">
            ...
            <div class="card-block">
                <div id="nestable-menu" class="m-b-10">
                    {!! link_to_route(config('quickadmin.route').'.kandang.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}
                </div>
...
<td>{{ $row->tanggal_berdiri }}</td>
                            ...
                            <td>
                                {!! link_to_route(config('quickadmin.route').'.kandang.edit', trans('quickadmin::templates.templates-view_index-edit'), array($row->id), array('class' => 'btn btn-sm btn-info')) !!}
                                {!! Form::open(array('style' => 'display: inline-block;', 'method' => 'DELETE', 'onsubmit' => "return confirm('".trans("quickadmin::templates.templates-view_index-are_you_sure")."');",  'route' => array(config('quickadmin.route').'.kandang.destroy', $row->id))) !!}
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.kandang.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
