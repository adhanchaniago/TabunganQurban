        ...
        <div class="card">
            ...
            <div class="card-block">
                <div id="nestable-menu" class="m-b-10">
                    {!! link_to_route(config('quickadmin.route').'.anggaranpakan.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}
                </div>


                @if ($anggaranpakan->count())
                    ...
                    <div class="table-responsive dt-responsive">
                        ...
                        <table class="table table-striped table-bordered nowrap datatable" id="datatable">
                            ...
                            @foreach ($anggaranpakan as $row)
                                <tr>
                                    ...
                                    <td>
                                        {!! link_to_route(config('quickadmin.route').'.anggaranpakan.edit', trans('quickadmin::templates.templates-view_index-edit'), array($row->id), array('class' => 'btn btn-sm btn-info')) !!}
                                        {!! Form::open(array('style' => 'display: inline-block;', 'method' => 'DELETE', 'onsubmit' => "return confirm('".trans("quickadmin::templates.templates-view_index-are_you_sure")."');",  'route' => array(config('quickadmin.route').'.anggaranpakan.destroy', $row->id))) !!}
                        ...
                        {!! Form::open(['route' => config('quickadmin.route').'.anggaranpakan.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
