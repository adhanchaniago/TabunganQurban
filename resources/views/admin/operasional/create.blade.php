    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                ...
                {!! Form::open(array('route' => config('quickadmin.route').'.operasional.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        {!! Form::text('tanggal_pengeluaran', old('tanggal_pengeluaran'), array('class'=>'form-control datepicker form-control-primary')) !!}
